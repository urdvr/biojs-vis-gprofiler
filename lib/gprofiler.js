...
function GProfiler() {
  ...
  var attrs = {
    GP_ROOT_URL   : 'https://biit.cs.ut.ee/gprofiler_beta/api/gost/profile/',
    MAX_URL_LEN   : 4096,
...
GProfiler.prototype._warnAboutDeprecation = function(attrs) {  
  ...
  var regionExplanation = 'Region symbols are detected automatically in g:Profiler 2';
  var maxPValExplanation = 'Superseded by the `userThreshold` parameter';
  ...
  this.$.each(deprecated, function(attr, explanation) {
      if (typeof attrs[attr] === 'undefined') {
        ...
        var attrMessage = message.replace('%s', attr) + ' (' + explanation + ')';        
